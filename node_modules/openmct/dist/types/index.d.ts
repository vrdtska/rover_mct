...
declare module "src/api/composition/CompositionProvider" {
    ...
    export default class CompositionProvider {
         ...
         */
        load(domainObject: DomainObject): Promise<Identifier[] | DomainObject[]>;
        /**
...
declare module "src/api/composition/DefaultCompositionProvider" {
    ...
    export default class DefaultCompositionProvider extends CompositionProvider {
         ...
         */
        override load(domainObject: DomainObject): Promise<Identifier[]>;
    }
    export type DomainObject = import("openmct").DomainObject;
    export type Identifier = import("openmct").Identifier;
    export type CompositionAPI = import("src/api/composition/CompositionAPI").default;
...
declare module "src/api/faultmanagement/FaultManagementAPI" {
     ...
     *****************************************************************************/
    /** @type {ShelveDuration[]} */
    export const DEFAULT_SHELVE_DURATIONS: ShelveDuration[];
    /**
    ...
    export default class FaultManagementAPI {
         ...
         */
        acknowledgeFault(fault: Fault, ackData: any): Promise<T>;
        /**
         ...
         */
        getShelveDurations(): ShelveDuration[] | undefined;
    }
    export type ShelveDuration = {
        /**
         * - The name of the shelve duration
         */
        name: string;
        /**
         * - The value of the shelve duration in milliseconds, or null for unlimited
         */
        value: number | null;
    };
...
declare module "src/plugins/planExecutionMonitoring/planExecutionMonitoringIdentifier" {
    export function createPlanExecutionMonitoringIdentifier(namespace?: string): {
        key: string;
        namespace: string;
    };
    /*****************************************************************************
...
declare module "src/api/objects/NamespaceProvider" {
    /*****************************************************************************
     * Open MCT, Copyright (c) 2014-2024, United States Government
     * as represented by the Administrator of the National Aeronautics and Space
     * Administration. All rights reserved.
    ...
    export default class NamespaceProvider {
        constructor(namespace: any, provider: any);
...
declare module "src/api/objects/RootObjectCompositionProvider" {
    export default class RootObjectCompositionProvider extends CompositionProvider {
        constructor(openmct: any, rootRegistry: any);
        appliesTo(domainObject: any): boolean;
        load(domainObject: any): any;
        on(domainObject: any, event: any, callback: any, context: any): void;
        off(domainObject: any, event: any, callback: any, context: any): void;
        add(domainObject: any, childId: any): void;
        remove(domainObject: any, childId: any): void;
        includes(domainObject: any, childId: any): any;
        #private;
    }
    import CompositionProvider from "src/api/composition/CompositionProvider";
}
...
declare module "src/api/objects/RootRegistry" {
    ...
    export default class RootRegistry extends EventTarget {
        ...
        isRootObject(identifier: any): boolean;
        /**
        ...
        removeRoot(identifier: any): void;
        /**
...
declare module "src/api/objects/ObjectAPI" {
    ...
    export default class ObjectAPI {
         ...
         */
        addProvider(namespaceOrProvider: string | ObjectProvider, providerOrNothing?: any, ...args: any[]): void;
        /**
         * Get a domain object.
         *
         ...
         */
        getOriginalPath(identifierOrObject: any, path?: Array<DomainObject>, abortSignal?: AbortSignal): Promise<Array<DomainObject>>;
        /**
...
declare module "src/api/telemetry/BatchingWebSocket" {
    ...
    export type RequestIdleCallbackOptions = {
        /**
         * If the number of milliseconds represented by this
    ...
    class BatchingWebSocket extends EventTarget {
         ...
         */
        constructor(openmct: import('openmct.js').OpenMCT);
        /**
         ...
         */
        setMaxBufferSize(maxBatchSize: any): void;
        setThrottleRate(throttleRate: any): void;
        setThrottleMessagePattern(throttleMessagePattern: any): void;
        /**
...
declare module "src/api/time/TimeAPI" {
    ...
    class TimeAPI extends GlobalTimeContext {
         ...
         */
        addIndependentContext(keyString: string, boundsOrOffsets: TimeConductorBounds | ClockOffsets, clockKey: string): () => void;
        /**
...
declare module "src/api/telemetry/TelemetryAPI" {
    ...
    export default class TelemetryAPI {
         ...
         */
        sanitizeForSerialization(key: any, value: any): any;
        /**
         ...
         */
        hasNumericTelemetry(domainObject: import('openmct').DomainObject): boolean;
        /**
...
declare module "src/api/tooltips/ToolTipAPI" {
    ...
    class TooltipAPI {
        ...
        tooltip(options: {
            ...
            /**
             * css classes to use with the tool tip element
             */
            cssClasses: any[];
        }): Tooltip;
    }
...
declare module "src/api/types/TypeRegistry" {
    ...
    export default class TypeRegistry {
         ...
         */
        importLegacyTypes(types: TypeDefinition[]): void;
    }
    export type TypeDefinition = {
        /**
...
declare module "example/eventGenerator/EventLimitProvider" {
    export namespace SEVERITY_CSS {
        let WATCH: string;
        let WARNING: string;
        let DISTRESS: string;
        let CRITICAL: string;
    ...
    export default class EventLimitProvider {
        ...
        getLimitEvaluator(domainObject: any): {
             ...
             */
            evaluate: (datum: Datum, valueMetadata: object) => EvaluationResult;
        };
        getSeverity(datum: any, valueMetadata: any): {
            cssClass: any;
            name: any;
        } | undefined;
...
declare module "example/eventGenerator/EventWithAcknowledgeTelemetryProvider" {
    ...
    import EventTelemetryProvider from "example/eventGenerator/EventTelemetryProvider";
}
...
declare module "example/generator/WorkerInterface" {
    ...
    export default class WorkerInterface {
        ...
        dispatch(request: any, data: any, callback: any): string;
...
declare module "example/generator/StateGeneratorProvider" {
    ...
    export default class StateGeneratorProvider {
        supportsSubscribe(domainObject: any): boolean;
        subscribe(domainObject: any, callback: any, options: any): () => void;
        ...
        shouldBeFiltered(point: any, options: any): boolean;
    }
}
...
declare module "src/plugins/condition/criterion/TelemetryCriterion" {
    export default class TelemetryCriterion extends EventEmitter<string | symbol, any> {
        ...
        unsubscribeFromStaleness: Function | undefined;
        initialize(): void;
        telemetryObjectIdAsString: string | undefined;
        usesTelemetry(id: any): boolean | "" | undefined;
        ...
        shouldUpdateResult(datum: any, timesystem: any): boolean;
        updateResult(data: any, currentTimeSystemKey: any): void;
        requestLAD(telemetryObjects: any, requestOptions: any): Promise<{
            id: any;
            data: {
                result: boolean;
            };
...
declare module "src/plugins/condition/Condition" {
    export default class Condition extends EventEmitter<string | symbol, any> {
         ...
         */
        constructor(definition: any, openmct: any, conditionManager: any);
        openmct: any;
        ...
        updateResult(latestDataTable: any, telemetryIdThatChanged: any): void;
...
declare module "src/plugins/condition/ConditionManager" {
    export default class ConditionManager extends EventEmitter<string | symbol, any> {
         ...
         * @param {import('openmct.js').OpenMCT} openmct
         */
        constructor(conditionSetDomainObject: import('openmct.js').DomainObject, openmct: import('openmct.js').OpenMCT);
        openmct: import("src/MCT").MCT;
        conditionSetDomainObject: import("src/api/objects/ObjectAPI").DomainObject;
        timeSystems: import("src/api/time/TimeAPI").TimeSystem[];
        composition: import("src/api/composition/CompositionCollection").default | undefined;
        shouldEvaluateNewTelemetry(currentTimestamp: any): boolean;
        compositionLoad: Promise<import("src/api/objects/ObjectAPI").DomainObject[]>;
        ...
        subscribeToTelemetry(telemetryObject: any): void;
        ...
        telemetryReceived(endpoint: any, data: any): void;
        updateConditionResults(keyStringForUpdatedTelemetryObject: any): any;
        updateCurrentCondition(timestamp: any, matchingCondition: any): void;
        getTestData(metadatum: any, identifier: any): any;
        createNormalizedDatum(telemetryDatum: any, endpoint: any): any;
...
declare module "src/plugins/conditionWidget/conditionWidgetStylesInterceptor" {
    /*****************************************************************************
     * Open MCT, Copyright (c) 2014-2024, United States Government
     * as represented by the Administrator of the National Aeronautics and Space
     * Administration. All rights reserved.
     ...
     * at runtime from the About dialog for additional information.
     *****************************************************************************/
    export default function conditionWidgetStylesInterceptor(openmct: any): {
        appliesTo: (identifier: any, domainObject: any) => boolean;
        invoke: (identifier: any, domainObject: any) => any;
    };
}
...
declare module "src/plugins/correlationTelemetryPlugin/plugin" {
    export default function CorrelationTelemetryPlugin(): (openmct: any) => void;
}
...
declare module "src/plugins/displayLayout/displayLayoutStylesInterceptor" {
    /*****************************************************************************
     * Open MCT, Copyright (c) 2014-2024, United States Government
     * as represented by the Administrator of the National Aeronautics and Space
     * Administration. All rights reserved.
     ...
     * at runtime from the About dialog for additional information.
     *****************************************************************************/
    export default function displayLayoutStylesInterceptor(openmct: any): {
        appliesTo: (identifier: any, domainObject: any) => boolean;
        invoke: (identifier: any, domainObject: any) => any;
    };
}
...
declare module "src/plugins/events/EventInspectorViewProvider" {
    export default function EventInspectorViewProvider(openmct: any): {
        key: string;
        name: string;
        canView: (selection: any) => any;
        view: (selection: any) => {
...
declare module "src/plugins/events/EventTimelineViewProvider" {
    export default function EventTimestripViewProvider(openmct: any, extendedLinesBus: any): {
        key: string;
        name: string;
        cssClass: string;
        priority: () => any;
...
declare module "src/plugins/events/plugin" {
    export default function plugin(extendedLinesBus: any): (openmct: any) => void;
}
...
declare module "src/plugins/filters/FiltersInspectorViewProvider" {
    export default class FiltersInspectorViewProvider {
        ...
        view(selection: any): {
            show: (element: any) => void;
            showTab: (isEditing: any) => true | undefined;
            priority: () => any;
            destroy: () => void;
        };
    }
...
declare module "src/plugins/flexibleLayout/flexibleLayoutStylesInterceptor" {
    /*****************************************************************************
     * Open MCT, Copyright (c) 2014-2024, United States Government
     * as represented by the Administrator of the National Aeronautics and Space
     * Administration. All rights reserved.
     ...
     * at runtime from the About dialog for additional information.
     *****************************************************************************/
    export default function flexibleLayoutStylesInterceptor(openmct: any): {
        appliesTo: (identifier: any, domainObject: any) => boolean;
        invoke: (identifier: any, domainObject: any) => any;
    };
}
...
declare module "src/plugins/gauge/GaugeCompositionPolicy" {
    ...
    export default function GaugeCompositionPolicy(openmct: any): {
        allow: (parent: any, child: any) => any;
    };
}
declare module "src/plugins/gauge/gaugeStylesInterceptor" {
    /*****************************************************************************
     * Open MCT, Copyright (c) 2014-2024, United States Government
     * as represented by the Administrator of the National Aeronautics and Space
     * Administration. All rights reserved.
     ...
     * at runtime from the About dialog for additional information.
     *****************************************************************************/
    export default function gaugeStylesInterceptor(openmct: any): {
        appliesTo: (identifier: any, domainObject: any) => boolean;
        invoke: (identifier: any, domainObject: any) => any;
    };
}
...
declare module "src/plugins/persistence/couch/CouchObjectProvider" {
    ...
    class CouchObjectProvider {
        ...
        isViewDefined(designDoc: any, viewName: any): Promise<boolean>;
        /**
         ...
         */
        getObjectsByView({ designDoc, viewName, keysToSearch, startKey, endKey, limit, objectIdField }: {
            /**
             * the name of the design document that the view belongs to
             */
            designDoc: string;
            viewName: string;
            /**
             * a list of discrete view keys to search for. View keys are not object identifiers.
             */
            keysToSearch?: string[] | undefined;
            /**
             * limit the search to a range of keys starting with the provided `startKey`. One of `keysToSearch` OR `startKey` AND `endKey` must be provided
             */
            startKey?: string | undefined;
            /**
             * limit the search to a range of keys ending with the provided `endKey`. One of `keysToSearch` OR `startKey` AND `endKey` must be provided
             */
            ...
            /**
             * The field (either key or value) to treat as an object key. If provided, include_docs will be set to false in the request, and the field will be used as an object identifier. A bulk request will be used to resolve objects from identifiers
             */
            objectIdField?: string | undefined;
        }, abortSignal: AbortSignal): Promise<Array<import('openmct.js').DomainObject>>;
...
declare module "src/plugins/persistence/couch/CouchSearchProvider" {
    ...
    class CouchSearchProvider {
         ...
         */
        constructor(couchObjectProvider: import('./CouchObjectProvider').default);
        couchObjectProvider: import("src/plugins/persistence/couch/CouchObjectProvider").default;
        searchTypes: any;
        useDesignDocuments: any;
        supportedSearchTypes: any[];
        supportsSearchType(searchType: any): boolean;
        isReadOnly(): boolean;
        search(query: any, abortSignal: any, searchType: any): Promise<any> | never[];
        searchForObjects(query: any, abortSignal: any): Promise<any[]>;
        searchForAnnotations(keyString: any, abortSignal: any): Promise<any>;
        searchForTags(tagsArray: any, abortSignal: any): Promise<any[]> | never[];
        #private;
    }
}
...
declare module "src/plugins/planExecutionMonitoring/planExecutionMonitoringInterceptor" {
    export default planExecutionMonitoringInterceptor;
    export type PlanExecutionMonitoringOptions = {
        /**
         * the {namespace, key} to use for the plan execution monitoring object.
         */
        identifier: import('openmct').Identifier;
        /**
         * The name of the plan execution monitoring model.
         */
        name: string;
        /**
         * the priority of the interceptor. By default, it is low.
     ...
     * @returns {Object}
     */
    function planExecutionMonitoringInterceptor(openmct: import("openmct").OpenMCT, options: PlanExecutionMonitoringOptions): any;
}
...
declare module "src/plugins/plan/inspector/PlanInspectorViewProvider" {
    export default function PlanInspectorViewProvider(openmct: any): {
        key: string;
        name: string;
        canView: (selection: any) => boolean;
        view: (selection: any) => {
...
declare module "src/plugins/plot/actions/ViewActions" {
    ...
    const viewActions: {
        ...
        cssClass: string;
        group: string;
        invoke(objectPath: any, view: any, filename: any): void;
    }[];
}
...
declare module "src/plugins/plot/overlayPlot/overlayPlotStylesInterceptor" {
    /*****************************************************************************
     * Open MCT, Copyright (c) 2014-2024, United States Government
     * as represented by the Administrator of the National Aeronautics and Space
     * Administration. All rights reserved.
     ...
     * at runtime from the About dialog for additional information.
     *****************************************************************************/
    export default function overlayPlotStylesInterceptor(openmct: any): {
        appliesTo: (identifier: any, domainObject: any) => boolean;
        invoke: (identifier: any, domainObject: any) => any;
    };
}
...
declare module "src/plugins/remoteClock/requestInterceptor" {
     ...
     */
    function remoteClockRequestInterceptor(openmct: any, _remoteClockIdentifier: any, waitForBounds: Function): any;
}
...
declare module "src/plugins/telemetryTable/constants" {
...
declare module "src/plugins/telemetryTable/TelemetryTableConfiguration" {
    export default class TelemetryTableConfiguration extends EventEmitter<string | symbol, any> {
        ...
        getSortOptions(): any;
        setSortOptions(sortOptions: any): void;
        getConfiguration(): any;
        updateConfiguration(configuration: any): void;
...
declare module "src/plugins/telemetryTable/telemetryTableStylesInterceptor" {
    /*****************************************************************************
     * Open MCT, Copyright (c) 2014-2024, United States Government
     * as represented by the Administrator of the National Aeronautics and Space
     * Administration. All rights reserved.
     ...
     * at runtime from the About dialog for additional information.
     *****************************************************************************/
    export default function telemetryTableStylesInterceptor(openmct: any): {
        appliesTo: (identifier: any, domainObject: any) => any;
        invoke: (identifier: any, domainObject: any) => any;
    };
}
...
declare module "src/plugins/telemetryTable/collections/TableRowCollection" {
    ...
    export default class TableRowCollection extends EventEmitter<string | symbol, any> {
         ...
         */
        updateRowInPlace(incomingRow: any, index: number): void;
    ...
    export type TelemetryTableRow = any;
    import { EventEmitter } from "eventemitter3";
}
...
declare module "src/plugins/telemetryTable/TelemetryTableRow" {
    export default class TelemetryTableRow {
         ...
         */
        updateWithDatum(row: TelemetryTableRow): void;
    }
}
...
declare module "src/plugins/timeConductor/plugin" {
     ...
     */
    export default function _default(config: TimeConductorConfig): Function;
    export type TimeConductorConfig = {
        menuOptions: MenuOptions;
        /**
         * the rate in milliseconds in which to throttle time conductor visual updates
         */
        throttleRate: number | null;
        /**
         * the maximum number of records to keep in the history
         */
        records: number | null;
    };
    export type MenuOptions = Array<FixedMenuOption | RealtimeMenuOption>;
    export type FixedMenuOption = {
        /**
         * the name of this option
         */
        name: string | null;
        /**
         * the key of the time system to use for this option
         */
        timeSystem: string;
        /**
         * the starting bounds for this option
         */
        bounds: TimeConductorBounds;
    };
    export type RealtimeMenuOption = {
        /**
         * the name of this option
         */
        name: string | null;
        /**
         * the key of the time system for this option
         */
        timeSystem: string;
        /**
         * the key of the clock for this option
         */
        clock: string;
        /**
         * the starting bounds for this option
    ...
    export type RealtimePreset = {
        ...
        label: string;
        /**
         * the clock offsets for this preset
         */
        clockOffsets: ClockOffsets;
    };
    export type TimeConductorBounds = import("src/api/time/TimeContext").TimeConductorBounds;
...
declare module "src/plugins/timeline/Container" {
...
declare module "src/plugins/timeline/configuration" {
    /*****************************************************************************
     * Open MCT, Copyright (c) 2014-2024, United States Government
     * as represented by the Administrator of the National Aeronautics and Space
     * Administration. All rights reserved.
     ...
     */
    export default function getDefaultConfiguration(): TimeStripConfig;
    /**
     * configuration for Time Strip views
     */
    export type TimeStripConfig = {
        /**
         * true for independent time, false for global time
         */
        useIndependentTime: boolean;
        containers: Array<import('./Container').default>;
        swimLaneLabelWidth: number;
    };
}
declare module "src/plugins/timeline/ExtendedLinesBus" {
    /*****************************************************************************
     * Open MCT, Copyright (c) 2014-2024, United States Government
     * as represented by the Administrator of the National Aeronautics and Space
     * Administration. All rights reserved.
    ...
    export default class ExtendedLinesBus extends EventTarget {
        updateExtendedLines(keyString: any, lines: any): void;
        disableExtendEventLines(keyString: any): void;
        enableExtendEventLines(keyString: any): void;
        updateHoverExtendEventLine(keyString: any, id: any): void;
    }
}
...
declare module "src/plugins/timeline/TimelineElementsViewProvider" {
    export default function TimelineElementsViewProvider(openmct: any): {
        key: string;
        name: string;
        canView: (selection: any) => boolean;
        view: (selection: any) => {
...
declare module "src/plugins/timeline/TimelineViewProvider" {
    export default function TimelineViewProvider(openmct: any, extendedLinesBus: any): {
        key: string;
        name: string;
        cssClass: string;
        canView(domainObject: any): boolean;
...
declare module "src/plugins/timeline/plugin" {
    export default function _default(): {
        (openmct: any): void;
        extendedLinesBus: ExtendedLinesBus;
    };
    import ExtendedLinesBus from "src/plugins/timeline/ExtendedLinesBus";
    export const extendedLinesBus: ExtendedLinesBus;
}
...
declare module "src/plugins/utcTimeSystem/DurationFormat" {
    ...
    class DurationFormat implements Format {
        key: string;
        format(value: any, formatString: any): string;
        parse(text: any): number;
        validate(text: any): boolean;
    }
}
...
declare module "src/plugins/utcTimeSystem/UTCTimeFormat" {
    ...
    export default class UTCTimeFormat implements Format {
        ...
        DATE_FORMATS: {
            ...
            PRECISION_DEFAULT_WITH_ZULU_MOMENT: string;
         ...
         */
        parse(text: number | string, formatString: string): number;
        validate(text: any): boolean;
    }
}
...
declare module "src/MCT" {
    ...
    export class MCT extends EventEmitter<string | symbol, any> {
         ...
         */
        start(domElementOrSelector: Element | null, isHeadlessMode?: boolean): void;
        startHeadless(): void;
        /**
...
declare module "src/api/objects/InMemorySearchWorker" {
    export {};
}
declare module "src/api/time/IndependentTimeContext" {
    ...
    class IndependentTimeContext extends TimeContext {
         ...
         * @override
         */
        override isFixed(...args: any[]): boolean;
        /**
         * @returns {number}
         * @override
         */
...
declare module "src/api/tooltips/tooltipMixins" {
    ...
    namespace tooltipHelpers {
        namespace methods {
            ...
            function buildToolTip(tooltipText: any, tooltipLocation: any, elementRef: any, cssClasses: any): void;
